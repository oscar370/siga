    ...
    public partial class InitialPostgresSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnityOfMeasures", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ReferenceInvoice = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnityOfMeasureId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_UnityOfMeasures_UnityOfMeasureId",
                        column: x => x.UnityOfMeasureId,
                        principalTable: "UnityOfMeasures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialQuantity = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Lots_Purchases_PurchaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    QuantityRequested = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    QuantitySold = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    UnitCostApplied = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleTransactions_Lots_LotId",
                        column: x => x.LotId,
                        principalTable: "Lots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleTransactions_SaleDetails_SaleDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lots_ProductId_AvailableQuantity_EntryDate",
                table: "Lots",
                columns: new[] { "ProductId", "AvailableQuantity", "EntryDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Lots_PurchaseId",
                table: "Lots",
                column: "PurchaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_UnityOfMeasureId",
                table: "Products",
                column: "UnityOfMeasureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleTransactions_LotId",
                table: "SaleTransactions",
                column: "LotId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleTransactions_SaleDetailsId",
                table: "SaleTransactions",
